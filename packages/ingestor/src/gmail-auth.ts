...
export function hasGmailEnv(env: Record<string, string | undefined> = process.env): boolean {
...
export function gmailClient(env: Record<string, string | undefined> = process.env): gmail_v1.Gmail {
  if (!hasGmailEnv(env)) {
